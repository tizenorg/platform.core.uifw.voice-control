...
typedef enum {
	VC_CONFIG_ERROR_NONE			= 0,		/**< Success, No error */
	VC_CONFIG_ERROR_OUT_OF_MEMORY		= -ENOMEM,	/**< Out of Memory */
	VC_CONFIG_ERROR_IO_ERROR		= -EIO,		/**< I/O error */
	VC_CONFIG_ERROR_INVALID_PARAMETER	= -EINVAL,	/**< Invalid parameter */
	VC_CONFIG_ERROR_INVALID_STATE		= -0x0100021,	/**< Invalid state */
	VC_CONFIG_ERROR_INVALID_LANGUAGE	= -0x0100022,	/**< Invalid voice */
	VC_CONFIG_ERROR_ENGINE_NOT_FOUND	= -0x0100023,	/**< No available VC-engine  */
	VC_CONFIG_ERROR_OPERATION_FAILED	= -0x0100024	/**< Operation failed  */
}vc_config_error_e;
